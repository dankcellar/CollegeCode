...
public class Person implements Comparable<Person> {
	...
	// We will order our Person objects by birthday:
	// return -1 if 'this' was born before 'rhs'
	// return +1 if 'this' was born after 'rhs'
	// return 0 if 'this' and 'rhs' share the same birthday
