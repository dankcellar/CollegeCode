 ...
 * (C:\\Users\\Command Center\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
...
public class S3TransferProgressSample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * (C:\\Users\\Command Center\\.aws\\credentials).
         *
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\Command Center\\.aws\\credentials), and is in valid format.",
                    e);
        }
